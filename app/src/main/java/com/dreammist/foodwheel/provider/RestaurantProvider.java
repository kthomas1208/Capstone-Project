...
import com.dreammist.foodwheel.provider.base.BaseContentProvider;
import com.dreammist.foodwheel.provider.restaurant.RestaurantColumns;

import java.util.Arrays;

public class RestaurantProvider extends BaseContentProvider {
    ...
    public static final String AUTHORITY = "com.dreammist.foodwheel.provider";
    public static final String CONTENT_URI_BASE = "content://" + AUTHORITY;

    private static final int URI_TYPE_RESTAURANT = 0;
    private static final int URI_TYPE_RESTAURANT_ID = 1;
    ...
    protected SQLiteOpenHelper createSqLiteOpenHelper() {
        return RestaurantSQLiteOpenHelper.getInstance(getContext());
    }
